CREATE TABLE [EBUS].[ActiveEventsViaje_32022_910] (
...
GO
CREATE NONCLUSTERED INDEX [FechaHoraEvento_ActiveEventsViaje_32022_910]
    ON [EBUS].[ActiveEventsViaje_32022_910]([FechaHora] ASC, [EventTypeID] ASC);


GO
CREATE NONCLUSTERED INDEX [FechaHoraEvento_ActiveEventsRecarga_32022_910]
    ON [EBUS].[ActiveEventsViaje_32022_910]([FechaHora] ASC, [EventTypeID] ASC);
