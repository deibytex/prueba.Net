CREATE TABLE [EBUS].[ActiveEventsViaje_102021_915] (
...
GO
CREATE NONCLUSTERED INDEX [FechaHoraEvento_ActiveEventsViaje_102021_915]
    ON [EBUS].[ActiveEventsViaje_102021_915]([FechaHora] ASC, [EventTypeID] ASC);
