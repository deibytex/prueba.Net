CREATE TABLE [EBUS].[ActiveEventsViaje_12022_915] (
...
GO
CREATE NONCLUSTERED INDEX [FechaHoraEvento_ActiveEventsViaje_12022_915]
    ON [EBUS].[ActiveEventsViaje_12022_915]([FechaHora] ASC, [EventTypeID] ASC);


GO
CREATE NONCLUSTERED INDEX [FechaHoraEvento_ActiveEventsRecarga_12022_915]
    ON [EBUS].[ActiveEventsViaje_12022_915]([FechaHora] ASC, [EventTypeID] ASC);
