CREATE TABLE [EBUS].[ActiveEventsViaje_122021_858] (
...
GO
CREATE NONCLUSTERED INDEX [FechaHoraEvento_ActiveEventsViaje_122021_858]
    ON [EBUS].[ActiveEventsViaje_122021_858]([FechaHora] ASC, [EventTypeID] ASC);


GO
CREATE NONCLUSTERED INDEX [FechaHoraEvento_ActiveEventsRecarga_122021_858]
    ON [EBUS].[ActiveEventsViaje_122021_858]([FechaHora] ASC, [EventTypeID] ASC);
