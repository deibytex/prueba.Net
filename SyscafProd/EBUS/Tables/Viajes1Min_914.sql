CREATE TABLE [EBUS].[Viajes1Min_914] (
...
GO
CREATE NONCLUSTERED INDEX [idxViajes1Min_914fecha]
    ON [EBUS].[Viajes1Min_914]([Fecha] ASC)
    INCLUDE([Movil], [Operador], [EventId], [EsProcesado], [fechasistema]);
