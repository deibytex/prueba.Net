CREATE TABLE [EBUS].[ActiveEventsViaje_22022_914] (
...
GO
CREATE NONCLUSTERED INDEX [FechaHoraEvento_ActiveEventsViaje_22022_914]
    ON [EBUS].[ActiveEventsViaje_22022_914]([FechaHora] ASC, [EventTypeID] ASC);


GO
CREATE NONCLUSTERED INDEX [FechaHoraEvento_ActiveEventsRecarga_22022_914]
    ON [EBUS].[ActiveEventsViaje_22022_914]([FechaHora] ASC, [EventTypeID] ASC);
