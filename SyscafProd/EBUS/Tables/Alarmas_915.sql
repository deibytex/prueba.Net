...
GO
CREATE NONCLUSTERED INDEX [idxAlarmas_915segevent]
    ON [EBUS].[Alarmas_915]([AlarmasId] ASC);


GO
CREATE NONCLUSTERED INDEX [idxAlarmas_915segfecha]
    ON [EBUS].[Alarmas_915]([Fecha] ASC);
