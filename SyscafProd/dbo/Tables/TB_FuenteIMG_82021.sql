CREATE TABLE [dbo].[TB_FuenteIMG_82021] (
    ...
    CONSTRAINT [PK_TB_FuenteIMG] PRIMARY KEY CLUSTERED ([Consecutivo] ASC)
);


GO
CREATE NONCLUSTERED INDEX [FuenteIMG]
    ON [dbo].[TB_FuenteIMG_82021]([ClienteIdS] ASC, [TripStart] ASC)
    INCLUDE([TripNo]);
