CREATE TABLE [PORTAL].[TB_Event_32022_864] (
...
GO
CREATE NONCLUSTERED INDEX [nci_wi_TB_Event_32022_864]
    ON [PORTAL].[TB_Event_32022_864]([EventTypeId] ASC)
    INCLUDE([assetId], [StartDateTime], [driverId], [EsProcesado], [IseBus], [EsActivo]);


GO
CREATE NONCLUSTERED INDEX [nci_wi_TB_startdatetime_32022_864]
    ON [PORTAL].[TB_Event_32022_864]([StartDateTime] ASC)
