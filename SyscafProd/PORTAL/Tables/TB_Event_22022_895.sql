CREATE TABLE [PORTAL].[TB_Event_22022_895] (
...
GO
CREATE NONCLUSTERED INDEX [nci_wi_TB_Event_22022_895]
    ON [PORTAL].[TB_Event_22022_895]([EventTypeId] ASC)
    INCLUDE([assetId], [StartDateTime], [driverId], [EsProcesado], [IseBus], [EsActivo]);


GO
CREATE NONCLUSTERED INDEX [nci_wi_TB_startdatetime_22022_895]
    ON [PORTAL].[TB_Event_22022_895]([StartDateTime] ASC)
