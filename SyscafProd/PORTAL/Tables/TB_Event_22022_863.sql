CREATE TABLE [PORTAL].[TB_Event_22022_863] (
...
GO
CREATE NONCLUSTERED INDEX [nci_wi_TB_Event_22022_863]
    ON [PORTAL].[TB_Event_22022_863]([EventTypeId] ASC)
    INCLUDE([assetId], [StartDateTime], [driverId], [EsProcesado], [IseBus], [EsActivo]);


GO
CREATE NONCLUSTERED INDEX [nci_wi_TB_startdatetime_22022_863]
    ON [PORTAL].[TB_Event_22022_863]([StartDateTime] ASC)
