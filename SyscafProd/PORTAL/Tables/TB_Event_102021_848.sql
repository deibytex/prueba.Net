CREATE TABLE [PORTAL].[TB_Event_102021_848] (
...
GO
CREATE NONCLUSTERED INDEX [nci_wi_TB_Event_102021_848]
    ON [PORTAL].[TB_Event_102021_848]([ClienteIds] ASC, [EventTypeId] ASC)
    INCLUDE([assetId], [FuelUsedLitres], [StartDateTime], [TotalOccurances], [TotalTimeSeconds]);


GO
CREATE NONCLUSTERED INDEX [nci_wi_TB_EventTypeId_102021_848]
    ON [PORTAL].[TB_Event_102021_848]([EventTypeId] ASC);


GO
CREATE NONCLUSTERED INDEX [nci_wi_TB_startdatetime_102021_848]
    ON [PORTAL].[TB_Event_102021_848]([StartDateTime] ASC);
