CREATE TABLE [PORTAL].[TB_Event_102021_871] (
...
GO
CREATE NONCLUSTERED INDEX [nci_wi_TB_Event_102021_871]
    ON [PORTAL].[TB_Event_102021_871]([ClienteIds] ASC, [EventTypeId] ASC)
    INCLUDE([assetId], [FuelUsedLitres], [StartDateTime], [TotalOccurances], [TotalTimeSeconds]);


GO
CREATE NONCLUSTERED INDEX [nci_wi_TB_EventTypeId_102021_871]
    ON [PORTAL].[TB_Event_102021_871]([EventTypeId] ASC);


GO
CREATE NONCLUSTERED INDEX [nci_wi_TB_startdatetime_102021_871]
    ON [PORTAL].[TB_Event_102021_871]([StartDateTime] ASC);
