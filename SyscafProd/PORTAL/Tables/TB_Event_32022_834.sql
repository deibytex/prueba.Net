CREATE TABLE [PORTAL].[TB_Event_32022_834] (
...
GO
CREATE NONCLUSTERED INDEX [nci_wi_TB_Event_32022_834]
    ON [PORTAL].[TB_Event_32022_834]([EventTypeId] ASC)
    INCLUDE([assetId], [StartDateTime], [driverId], [EsProcesado], [IseBus], [EsActivo]);


GO
CREATE NONCLUSTERED INDEX [nci_wi_TB_startdatetime_32022_834]
    ON [PORTAL].[TB_Event_32022_834]([StartDateTime] ASC)
