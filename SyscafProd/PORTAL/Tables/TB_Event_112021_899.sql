CREATE TABLE [PORTAL].[TB_Event_112021_899] (
...
GO
CREATE NONCLUSTERED INDEX [nci_wi_TB_Event_112021_899]
    ON [PORTAL].[TB_Event_112021_899]([ClienteIds] ASC, [EventTypeId] ASC)
    INCLUDE([assetId], [FuelUsedLitres], [StartDateTime], [TotalOccurances], [TotalTimeSeconds]);


GO
CREATE NONCLUSTERED INDEX [nci_wi_TB_EventTypeId_112021_899]
    ON [PORTAL].[TB_Event_112021_899]([EventTypeId] ASC);


GO
CREATE NONCLUSTERED INDEX [nci_wi_TB_startdatetime_112021_899]
    ON [PORTAL].[TB_Event_112021_899]([StartDateTime] ASC);
