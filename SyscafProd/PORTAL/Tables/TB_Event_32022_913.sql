CREATE TABLE [PORTAL].[TB_Event_32022_913] (
...
GO
CREATE NONCLUSTERED INDEX [nci_wi_TB_Event_32022_913]
    ON [PORTAL].[TB_Event_32022_913]([EventTypeId] ASC)
    INCLUDE([assetId], [StartDateTime], [driverId], [EsProcesado], [IseBus], [EsActivo]);


GO
CREATE NONCLUSTERED INDEX [nci_wi_TB_startdatetime_32022_913]
    ON [PORTAL].[TB_Event_32022_913]([StartDateTime] ASC)
