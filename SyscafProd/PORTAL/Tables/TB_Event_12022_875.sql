CREATE TABLE [PORTAL].[TB_Event_12022_875] (
...
GO
CREATE NONCLUSTERED INDEX [nci_wi_TB_Event_12022_875]
    ON [PORTAL].[TB_Event_12022_875]([EventTypeId] ASC)
    INCLUDE([assetId], [StartDateTime], [driverId], [EsProcesado], [IseBus], [EsActivo]);


GO
CREATE NONCLUSTERED INDEX [nci_wi_TB_startdatetime_12022_875]
    ON [PORTAL].[TB_Event_12022_875]([StartDateTime] ASC)
