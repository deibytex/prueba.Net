CREATE TABLE [PORTAL].[TB_Event_32022_894] (
...
GO
CREATE NONCLUSTERED INDEX [nci_wi_TB_Event_32022_894]
    ON [PORTAL].[TB_Event_32022_894]([EventTypeId] ASC)
    INCLUDE([assetId], [StartDateTime], [driverId], [EsProcesado], [IseBus], [EsActivo]);


GO
CREATE NONCLUSTERED INDEX [nci_wi_TB_startdatetime_32022_894]
    ON [PORTAL].[TB_Event_32022_894]([StartDateTime] ASC)
