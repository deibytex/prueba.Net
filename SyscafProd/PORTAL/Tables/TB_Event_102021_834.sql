CREATE TABLE [PORTAL].[TB_Event_102021_834] (
...
GO
CREATE NONCLUSTERED INDEX [nci_wi_TB_Event_102021_834]
    ON [PORTAL].[TB_Event_102021_834]([ClienteIds] ASC, [EventTypeId] ASC)
    INCLUDE([assetId], [FuelUsedLitres], [StartDateTime], [TotalOccurances], [TotalTimeSeconds]);


GO
CREATE NONCLUSTERED INDEX [nci_wi_TB_EventTypeId_102021_834]
    ON [PORTAL].[TB_Event_102021_834]([EventTypeId] ASC);


GO
CREATE NONCLUSTERED INDEX [nci_wi_TB_startdatetime_102021_834]
    ON [PORTAL].[TB_Event_102021_834]([StartDateTime] ASC);
