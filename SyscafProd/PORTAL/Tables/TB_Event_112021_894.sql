CREATE TABLE [PORTAL].[TB_Event_112021_894] (
...
GO
CREATE NONCLUSTERED INDEX [nci_wi_TB_Event_112021_894]
    ON [PORTAL].[TB_Event_112021_894]([ClienteIds] ASC, [EventTypeId] ASC)
    INCLUDE([assetId], [FuelUsedLitres], [StartDateTime], [TotalOccurances], [TotalTimeSeconds]);


GO
CREATE NONCLUSTERED INDEX [nci_wi_TB_EventTypeId_112021_894]
    ON [PORTAL].[TB_Event_112021_894]([EventTypeId] ASC);


GO
CREATE NONCLUSTERED INDEX [nci_wi_TB_startdatetime_112021_894]
    ON [PORTAL].[TB_Event_112021_894]([StartDateTime] ASC);
