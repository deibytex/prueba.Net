CREATE TABLE [PORTAL].[TB_Event_92021_858] (
...
GO
CREATE NONCLUSTERED INDEX [nci_wi_TB_Event_92021_858]
    ON [PORTAL].[TB_Event_92021_858]([ClienteIds] ASC, [EventTypeId] ASC)
    INCLUDE([assetId], [FuelUsedLitres], [StartDateTime], [TotalOccurances], [TotalTimeSeconds]);


GO
CREATE NONCLUSTERED INDEX [nci_wi_TB_EventTypeId_92021_858]
    ON [PORTAL].[TB_Event_92021_858]([EventTypeId] ASC);


GO
CREATE NONCLUSTERED INDEX [nci_wi_TB_startdatetime_92021_858]
    ON [PORTAL].[TB_Event_92021_858]([StartDateTime] ASC);
