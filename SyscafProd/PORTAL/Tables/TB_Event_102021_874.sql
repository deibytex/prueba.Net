CREATE TABLE [PORTAL].[TB_Event_102021_874] (
...
GO
CREATE NONCLUSTERED INDEX [nci_wi_TB_Event_102021_874]
    ON [PORTAL].[TB_Event_102021_874]([ClienteIds] ASC, [EventTypeId] ASC)
    INCLUDE([assetId], [FuelUsedLitres], [StartDateTime], [TotalOccurances], [TotalTimeSeconds]);


GO
CREATE NONCLUSTERED INDEX [nci_wi_TB_EventTypeId_102021_874]
    ON [PORTAL].[TB_Event_102021_874]([EventTypeId] ASC);


GO
CREATE NONCLUSTERED INDEX [nci_wi_TB_startdatetime_102021_874]
    ON [PORTAL].[TB_Event_102021_874]([StartDateTime] ASC);
