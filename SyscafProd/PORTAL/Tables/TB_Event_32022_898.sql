CREATE TABLE [PORTAL].[TB_Event_32022_898] (
...
GO
CREATE NONCLUSTERED INDEX [nci_wi_TB_Event_32022_898]
    ON [PORTAL].[TB_Event_32022_898]([EventTypeId] ASC)
    INCLUDE([assetId], [StartDateTime], [driverId], [EsProcesado], [IseBus], [EsActivo]);


GO
CREATE NONCLUSTERED INDEX [nci_wi_TB_startdatetime_32022_898]
    ON [PORTAL].[TB_Event_32022_898]([StartDateTime] ASC)
