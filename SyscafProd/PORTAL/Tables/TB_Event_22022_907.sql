CREATE TABLE [PORTAL].[TB_Event_22022_907] (
...
GO
CREATE NONCLUSTERED INDEX [nci_wi_TB_Event_22022_907]
    ON [PORTAL].[TB_Event_22022_907]([EventTypeId] ASC)
    INCLUDE([assetId], [StartDateTime], [driverId], [EsProcesado], [IseBus], [EsActivo]);


GO
CREATE NONCLUSTERED INDEX [nci_wi_TB_startdatetime_22022_907]
    ON [PORTAL].[TB_Event_22022_907]([StartDateTime] ASC)
