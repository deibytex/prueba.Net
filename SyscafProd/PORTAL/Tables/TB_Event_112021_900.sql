CREATE TABLE [PORTAL].[TB_Event_112021_900] (
...
GO
CREATE NONCLUSTERED INDEX [nci_wi_TB_Event_112021_900]
    ON [PORTAL].[TB_Event_112021_900]([ClienteIds] ASC, [EventTypeId] ASC)
    INCLUDE([assetId], [FuelUsedLitres], [StartDateTime], [TotalOccurances], [TotalTimeSeconds]);


GO
CREATE NONCLUSTERED INDEX [nci_wi_TB_EventTypeId_112021_900]
    ON [PORTAL].[TB_Event_112021_900]([EventTypeId] ASC);


GO
CREATE NONCLUSTERED INDEX [nci_wi_TB_startdatetime_112021_900]
    ON [PORTAL].[TB_Event_112021_900]([StartDateTime] ASC);
