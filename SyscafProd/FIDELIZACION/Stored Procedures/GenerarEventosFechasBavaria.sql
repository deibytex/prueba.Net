...
-- =============================================
--EXEC FIDELIZACION.GenerarEventosFechasBavaria 834,'20220110','20220124'
CREATE PROCEDURE FIDELIZACION.GenerarEventosFechasBavaria
(
    @ClienteId INT,
    ...
    SET @SQLScript
        = N'
          ...
          + N'] WHERE (  StartDateTime between @FechaI and  @FechaF )		  
				AND EventTypeID IN (' + @eventos + N', -7372181092478897411)			
				';
